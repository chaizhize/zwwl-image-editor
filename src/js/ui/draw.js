...
class Draw extends Submenu {
    constructor(subMenuElement, {locale, makeSvgIcon, menuBarPosition, usageStatistics}) {
        ...
        this._els = {
            ...
            drawColorPicker: new Colorpicker(
                this.selector('.tie-draw-color'), '#ff1040', this.toggleDirection, this.usageStatistics
            ),
            drawRange: new Range({
    ...
    changeStandbyMode() {
        ...
        // WAVE 添加波浪线
        this._els.lineSelectButton.classList.remove('wave');
    }
    ...
    _changeDrawType(event) {
        ...
        if (button) {
            // WAVE 添加波浪线
            const lineType = this.getButtonType(button, ['free', 'line', 'wave']);
