...
import Wave from './component/wave';// wave 添加波浪线
...
import WaveDrawingMode from './drawingMode/waveDrawing';// wave 添加波浪线
...
class Graphics {
    ...
    _createDrawingModeInstances() {
        ...
        this._register(this._drawingModeMap, new WaveDrawingMode());// wave 添加波浪线
    ...
    _createComponents() {
        ...
        this._register(this._componentMap, new Wave(this)); // wave 添加波浪线
